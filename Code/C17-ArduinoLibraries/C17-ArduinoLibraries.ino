...
void loop() {
    ...
    strip.setPixelColor(0, strip.Color(214,2,112));
    strip.setPixelColor(1, strip.Color(155,79,150));
    strip.setPixelColor(2, strip.Color(0,56,168));
    
    // strip.setPixelColor(0, strip.Color(252,209,22));
    // strip.setPixelColor(1, strip.Color(206,17,38));
    // strip.setPixelColor(2, strip.Color(0,56,168));
