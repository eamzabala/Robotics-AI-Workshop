...
void loop() {
    if (digitalRead(ONBOARD_SW) == LOW) {
       isRobotSpinning = !isRobotSpinning;
        //Buddy Holly riff
      //  playTone(NOTE_F6, 240);
      //  playTone(NOTE_C6, 240);
      //  playTone(NOTE_F6, 240);
      //  playTone(NOTE_G6, 240);     
      //  playTone(NOTE_GS6, 240);
      //  playTone(NOTE_G6, 240);
      //  playTone(NOTE_F6, 240);
      //  playTone(NOTE_CS6, 240);
      //  playTone(NOTE_C6, 480);

        // bday song
      //  playTone(NOTE_C6, 180);
      //  playTone(NOTE_C6, 60);
      //  playTone(NOTE_D6, 240);
      //  playTone(NOTE_C6, 240);     
      //  playTone(NOTE_F6, 240);
      //  playTone(NOTE_E6, 480);
      //  playTone(NOTE_C6, 180);
      //  playTone(NOTE_C6, 60);
      //  playTone(NOTE_D6, 240);
      //  playTone(NOTE_C6, 240);
      //  playTone(NOTE_G6, 240);
      //  playTone(NOTE_F6, 480);
      //  playTone(NOTE_C6, 180);     
      //  playTone(NOTE_C7, 60);
      //  playTone(NOTE_A6, 240);
      //  playTone(NOTE_F6, 240);
      //  playTone(NOTE_E6, 240);
      //  playTone(NOTE_D6, 480);
      //  playTone(NOTE_AS6, 180);     
      //  playTone(NOTE_AS6, 60);
      //  playTone(NOTE_A6, 240);
      //  playTone(NOTE_F6, 240);
      //  playTone(NOTE_G6, 240);
      //  playTone(NOTE_F6, 480);

      // better buddy holly rift
       playTone(NOTE_GS6, 240);
       playTone(NOTE_E6, 240);
       playTone(NOTE_GS6, 240);
       playTone(NOTE_AS6, 240);     
       playTone(NOTE_C6, 240);
       playTone(NOTE_AS6, 240);
       playTone(NOTE_GS6, 240);
       playTone(NOTE_E6, 240);
